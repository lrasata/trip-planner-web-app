...
import { createTrip } from "@/shared/store/redux/TripSlice.ts";
import dayjs, { Dayjs } from "dayjs";
import { formatDate } from "@/shared/utils/utils.ts";
import Spinner from "@/shared/components/Spinner.tsx";
import { draftTripActions } from "@/shared/store/redux/DraftTripSlice.ts";
...
const VerticalLinearStepper = lazy(
  () => import("@/shared/components/VerticalLinearStepper.tsx"),
);
